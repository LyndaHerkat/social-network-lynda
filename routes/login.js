...
const private_key = fs.readFileSync(path.join(__dirname, './RSA/key'));// reafileSync prend en parametre le path en fontion de l'endroit ou est lance le serveur (pas de chemin relatif)
